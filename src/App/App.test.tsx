...
describe('App',() =>{
  ...
  describe('Comportamento', () => {
    ...
    describe('QUANDO for mudar o idioma para o Pôrtugues', () => {
    ...
    describe('QUANDO for mudar o idioma para o Franês', () => {
      test(`DEVE mudar o texto de "Home" para "Accueil" QUANDO clicar no botão "Français"`, () => {
        setup()
        const botao = screen.getByText(/Français/i);
      ...
      test(`DEVE mudar o texto de "Contents" para "Contenu" QUANDO clicar no botão "Français"`, () => {
        ...
        const paginaInicial = screen.getByText(/Contenu/i);
        expect(paginaInicial).toBeDefined();
      });
      ...
      test(`DEVE mudar o texto de "About Us" para "à Propos" QUANDO clicar no botão "Français"`, () => {
        ...
        const paginaInicial = screen.getByText(/à Propos/i);
        expect(paginaInicial).toBeDefined();
      });
    })
